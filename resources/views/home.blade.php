                    ...
                    <div class="container">
                        ...
                        <div class="features-wrapper">
                            <div class="row gy-4 feature-wrapper">
                                ...
                                <div class="col-lg-6">
                                    <div class="feature-item animate-float delay-1" data-aos="fade-up"
                                        data-aos-delay="500">
                                        <div class="feature-icon">
                                            <i class="bi bi-calendar-check"></i>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="feature-item animate-float delay-2" data-aos="fade-up"
                                        data-aos-delay="550">
                                        <div class="feature-icon">
                                            <i class="bi bi-calendar-check"></i>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="feature-item animate-float delay-3" data-aos="fade-up"
                                        data-aos-delay="600">
                                        <div class="feature-icon">
                                            <i class="bi bi-calendar-check"></i>
                                        </div>
