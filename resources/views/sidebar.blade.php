            ...
            <span class="nav-link-text ms-1">Kelola Absensi</span>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('kaldik*') ? 'active' : '' }}" href="/kaldik">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="bi bi-calendar-event text-dark text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('plang*') ? 'active' : '' }}" href="/plang">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="bi bi-building text-dark text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Papan Nama</span>
                    </a>
                </li>
                <!--li class="nav-item">
